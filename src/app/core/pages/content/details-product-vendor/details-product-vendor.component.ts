...
@Component({
  selector: 'app-details-product-vendor',
  templateUrl: './details-product-vendor.component.html',
  styleUrl: './details-product-vendor.component.css',
  // host:{ngSkipHydration:'true'}
})
export class DetailsProductVendorComponent {

...
@Component({
  selector: 'app-product-per-category',
  templateUrl: './product-per-category.component.html',
  styleUrl: './product-per-category.component.css'
})
export class ProductPerCategoryComponent {
